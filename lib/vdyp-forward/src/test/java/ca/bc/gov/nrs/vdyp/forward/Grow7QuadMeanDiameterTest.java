...
class Grow7QuadMeanDiameterTest {

	protected static final Logger logger = LoggerFactory.getLogger(Grow7QuadMeanDiameterTest.class);
	...
	void testStandardPath() throws ProcessingException {
		...
		fpe.processPolygon(polygon, ExecutionStep.GROW_7_LAYER_DQ2);
