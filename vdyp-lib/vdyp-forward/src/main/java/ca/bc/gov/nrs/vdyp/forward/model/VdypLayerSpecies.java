...
public class VdypLayerSpecies {
	...
	private final Sp64DistributionSet speciesDistributions; // SP64DISTL1
	...
	public VdypLayerSpecies(
			...
			Sp64DistributionSet speciesDistributions, float siteIndex, float dominantHeight, float ageTotal,
	...
	public Sp64DistributionSet getSpeciesDistributions() {
