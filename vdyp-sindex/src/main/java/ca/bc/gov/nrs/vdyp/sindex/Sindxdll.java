...
//private static final int SI_ZH_END      = SI_ERR_NO_ANS; Unused
	 ...
	 */
	public static int DefCurveEst(int sp_index, int estab) throws SpeciesErrorException, EstablishmentErrorException, NoAnswerException {
		if (sp_index < 0 || sp_index >= SI_MAX_SPECIES) { // spec
			throw new SpeciesErrorException("Input parameter is not a valid species index: " + sp_index);
		}
	 ...
	 */
	public static int NextCurve(int sp_index, int cu_index) throws SpeciesErrorException, CurveErrorException, NoAnswerException {
		if (sp_index < 0 || sp_index >= SI_MAX_SPECIES) {
	 ...
	 */
	public static int HtSIToAge(int curve, double height, int ageType, double siteIndex, double y2bh, Reference<Double> age) 
			throws CommonCalculatorException {
	 ...
	 */
	public static int AgeSIToHt(int curve, double age, int ageType, double siteIndex, double y2bh, Reference<Double> height) 
			throws CommonCalculatorException {
	 ...
	 */
	public static int SIToSI(int sp_index1, double site, int sp_index2, Reference<Double> result) throws SpeciesErrorException, NoAnswerException {
		int i;
	 ...
	 */
	public static int SCToSI(int sp_index, char sitecl, char fiz, Reference<Double> site) throws CommonCalculatorException {
	 ...
	 */
	public static int
			AgeToAge(int cu_index, double age1, int age_type1, double y2bh, Reference<Double> result, int age_type2) throws AgeTypeErrorException {
