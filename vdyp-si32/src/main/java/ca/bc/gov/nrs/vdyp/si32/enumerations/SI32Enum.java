...
public interface SI32Enum<T> {
	/**
	 * @return the integer value of the enumeration entry. For a given
	 ...
	 * position (zero-based) of the entry in the enumeration, ignoring 
	 * any "housekeeping" entries (such as Unknown and the like.)
	 * 
	 ...
	 * the enum constant excluding the prefix common to all. This cannot be 
