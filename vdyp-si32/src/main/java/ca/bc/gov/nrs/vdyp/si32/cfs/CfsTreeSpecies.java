...
public enum CfsTreeSpecies implements SI32Enum<CfsTreeSpecies> {
	...
	SPRUCE_BLACK_ANDRed(7, 107, "Black and red spruce", CfsTreeGenus.SPRUCE),
	SPRUCE_RED_ANDWhite(8, 108, "Red and white spruce", CfsTreeGenus.SPRUCE),
	SPRUCE_OTHER(9, 109, "Other spruce", CfsTreeGenus.SPRUCE),
	/* 10 */
	SPRUCE_AND_BALSAMFir(10, 110, "Spruce and balsam fir", CfsTreeGenus.SPRUCE),
	...
	PINE_JACK_LODGEPOLEAndShore(25, 214, "Jack, lodgepole, and shore pine", CfsTreeGenus.PINE),
	PINE_OTHER(26, 215, "Other pine", CfsTreeGenus.PINE),
	PINE_HYBRID_JACKLodgepole(27, 216, "Hybrid jack and lodgepole pine", CfsTreeGenus.PINE),
	PINE_WHITEBARK_ANDLimber(28, 217, "Whitebark and limber pine", CfsTreeGenus.PINE),
	...
	FIR_BALSAM_ANDAlpine(34, 305, "Balsam and alpine fir", CfsTreeGenus.FIR),
	FIR_AMABILIS_ANDGrand(35, 306, "Alpine, amabilis, and grand fir", CfsTreeGenus.FIR),
	FIR_JAPANESE(36, 307, "Japanese fir", CfsTreeGenus.FIR),
	FIR_SPRUCE_ANDBalsam(37, 320, "Spruce and balsam fir", CfsTreeGenus.FIR),
	FIR_BALSAM_ANDSpruce(38, 321, "Balsam fir and spruce", CfsTreeGenus.FIR),
	...
	HEMLOCK_WESTERN_ANDMountain(43, 404, "Western and mountain hemlock", CfsTreeGenus.HEMLOCK),
	...
	CEDAR_AND_OTHERConifers(54, 703, "Cedar and other conifers", CfsTreeGenus.CEDAR_AND_OTHER_CONIFERS),
	...
	POPLAR_BALSAM_LARGETOOTHEastern(76, 1211, "Balsam poplar, largetooth aspen and eastern cottonwood", CfsTreeGenus.POPLAR),
	...
	BIRCH_WHITE_ANDGray(88, 1310, "White and gray birch", CfsTreeGenus.BIRCH),
	...
	MAPLE_SUGAR_ANDBlack(97, 1408, "Sugar and black maple", CfsTreeGenus.MAPLE),
	...
	MAPLE_SILVER_ANDRed(101, 1412, "Silver and red maple", CfsTreeGenus.MAPLE),
