...
public class SpeciesTable {
	...
	private static final int[] defaultSiteIndexCurves = defaultSiteIndexCurves;
	...
	public SpeciesTable() {
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				true, false, new float[] { 61.0f, 61.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"ABAL", "Silver Fir", "Abies alba", "B", "B", CfsTreeSpecies.UNKNOWN, true, true,
				false, new float[] { 57.0f, 42.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"ACT", "Black Cottonwood", "Populus balsamifera spp. trichocarpa", "CT", "AC",
				CfsTreeSpecies.UNKNOWN, true, true, false, new float[] { 61.0f, 61.0f },
				defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				new float[] { 57.0f, 42.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				false, true, new float[] { 57.0f, 42.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"BAI", "Amabilis fir (interior)", UNKNOWN_NAME, "B", "B", CfsTreeSpecies.UNKNOWN,
				true, false, true, new float[] { 57.0f, 42.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"BB", "Balsam Fir", "Abies balsamea", "B", "B", CfsTreeSpecies.UNKNOWN, true, false,
				true, new float[] { 57.0f, 42.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				new float[] { 61.0f, 61.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				CfsTreeSpecies.UNKNOWN, true, false, true, new float[] { 57.0f, 42.0f },
				defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				new float[] { 60.0f, 51.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"CI", "Incense Cedar", "Calocedrus decurrens", "??", "C", CfsTreeSpecies.UNKNOWN,
				true, false, true, new float[] { 60.0f, 51.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"COT", "Cottonwood", UNKNOWN_NAME, "CT", "AC", CfsTreeSpecies.UNKNOWN, true, true,
				false, new float[] { 61.0f, 61.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"CP", "Port Orford Cedar", UNKNOWN_NAME, "??", "C", CfsTreeSpecies.UNKNOWN, true,
				false, true, new float[] { 60.0f, 51.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				true, true, false, new float[] { 61.0f, 61.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				CfsTreeSpecies.FIR_DOUGLAS_AND_ROCKY_MOUNTAIN, true, false, true,
				new float[] { 48.0f, 48.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"G", "Dogwood", "Cornus", "G", "MB", CfsTreeSpecies.UNKNOWN, true, false, false,
				new float[] { 71.0f, 71.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				false, false, new float[] { 71.0f, 71.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"H", "Hemlock", "Tsuga", "H", "H", CfsTreeSpecies.HEMLOCK, true, false, true,
				new float[] { 61.0f, 51.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				true, false, true, new float[] { 61.0f, 61.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"HWI", "Western hemlock (interior)", UNKNOWN_NAME, "H", "H", CfsTreeSpecies.UNKNOWN,
				true, false, true, new float[] { 51.0f, 51.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"HXM", "Western/Mountain Hemlock cross", UNKNOWN_NAME, "H", "H",
				CfsTreeSpecies.UNKNOWN, true, false, true, new float[] { 61.0f, 51.0f },
				defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				false, true, new float[] { 61.0f, 51.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				false, false, new float[] { 61.0f, 61.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"L", "Larch", "Larix", "L", "L", CfsTreeSpecies.TAMARACK_LARCH, true, true, false,
				new float[] { 54.0f, 54.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"LA", "Alpine Larch", "Larix lyallii", "L", "L", CfsTreeSpecies.UNKNOWN, true, true,
				false, new float[] { 54.0f, 54.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				true, true, false, new float[] { 54.0f, 54.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				true, true, false, new float[] { 71.0f, 71.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				true, false, new float[] { 71.0f, 71.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				false, new float[] { 71.0f, 71.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				CfsTreeSpecies.UNKNOWN, true, false, false, new float[] { 71.0f, 71.0f },
				defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				new float[] { 50.0f, 50.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"PA", "Whitebark Pine", "Pinus albicaulis", "PL", "PA", CfsTreeSpecies.PINE_WHITEBARK,
				true, false, true, new float[] { 50.0f, 50.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"PF", "Limber Pine", "Pinus Flexilis", "PL", "PA", CfsTreeSpecies.UNKNOWN, true,
				false, true, new float[] { 50.0f, 50.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				false, true, new float[] { 55.0f, 55.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"PR", "Red Pine", "Pinus Resinosa", "PL", "PW", CfsTreeSpecies.UNKNOWN, true, false,
				true, new float[] { 55.0f, 55.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				false, true, new float[] { 30.0f, 30.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				CfsTreeSpecies.UNKNOWN, true, false, true, new float[] { 50.0f, 50.0f },
				defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"PY", "Yellow Pine", "Pinus ponderosa", "PY", "PY", CfsTreeSpecies.PINE_PONDEROSA,
				true, false, true, new float[] { 30.0f, 30.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				new float[] { 50.0f, 46.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"SA", "Norway Spruce", UNKNOWN_NAME, "??", "S", CfsTreeSpecies.SPRUCE_WHITE, true,
				false, true, new float[] { 50.0f, 46.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"SB", "Black Spruce", "Picea mariana", "S", "S", CfsTreeSpecies.SPRUCE_BLACK, true,
				false, true, new float[] { 46.0f, 46.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				true, new float[] { 50.0f, 46.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				CfsTreeSpecies.UNKNOWN, true, false, true, new float[] { 50.0f, 46.0f },
				defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
				"SXS", "Sitka Spruce Hybrid", "Picea sitchensis x", "S", "S", CfsTreeSpecies.UNKNOWN,
				true, false, true, new float[] { 50.0f, 46.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
		...
		addSpeciesToTable(new SpeciesDetails(
				...
				true, false, true, new float[] { 61.0f, 48.0f }, defaultSiteIndexCurves
		));
		addSpeciesToTable(new SpeciesDetails(
