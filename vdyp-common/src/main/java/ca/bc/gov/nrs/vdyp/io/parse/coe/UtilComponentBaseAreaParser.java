 ...
 * <ol>
 * <li>(cols 0-3) - a Utilization Component code (one of BA12, BA17 or
 * BA22)</li>
 * <li>(cols 5-6) - a Species code</li>
 * <li>(cols 8-11) - a BEC Scope key. This will be either blank, 'C' or 'I', or
 * a BEC Zone identifier</li>
 * <li>(cols 12-21) - float - coefficient one</li>
 * <li>(cols 22-31) - float - coefficient two</li>
 * </ol>
 * The result of the parse is a {@link MatrixMap3} of two coefficients indexed
 * by Utilization Component, Species, and then BEC Zone. The BEC Scope field is
 * converted in a (set of) BEC Zones in this way:
 * <ul>
