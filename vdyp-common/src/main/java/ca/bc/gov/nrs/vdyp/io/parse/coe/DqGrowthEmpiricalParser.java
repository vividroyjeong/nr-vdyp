...
/**
 * Parses a mapping from a Basal Area Group number to a list of ten
 ...
 * have content. If fewer than ten coefficients are supplied on a given line,
 * the remainder default to 0.0f.
 * <p>
 * The result of the parse is a map from a Basal Area Group number to a
 * (one-based) ten-element coefficient array.
 * <p>
 * Control index: 122
 * <p>
