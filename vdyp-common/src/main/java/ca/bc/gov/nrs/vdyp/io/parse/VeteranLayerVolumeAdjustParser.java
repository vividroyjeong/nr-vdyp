 ...
 * </ol>
 * Exactly 16 data items (one per species) must be present. There can be no
 * blank lines in the file, except possibly the last (17th) line provided its
 * empty.
 * <p>
 * The result of the parse is a {@link Map} of Species aliases (e.g., "AC") to a
