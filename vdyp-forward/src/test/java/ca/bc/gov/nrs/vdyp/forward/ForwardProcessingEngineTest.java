...
class ForwardProcessingEngineTest {
	...
	void testCalculateMissingSiteCurves() throws IOException, ResourceParseException, ProcessingException {
		...
		assertThat(fps.getProcessingState().getSiteCurveNumber(1), is(12));
		assertThat(fps.getProcessingState().getSiteCurveNumber(2), is(2));
		assertThat(fps.getProcessingState().getSiteCurveNumber(3), is(42));
		assertThat(fps.getProcessingState().getSiteCurveNumber(4), is(10));
		assertThat(fps.getProcessingState().getSiteCurveNumber(5), is(10));
	}
	...
	void testCalculateMissingSiteCurvesNoSiteCurveData() throws IOException, ResourceParseException, ProcessingException {
		...
		// Cannot check 0 since determinePolygonRankings has not been executed.
		assertThat(fps.getProcessingState().getSiteCurveNumber(1), is(118));
		assertThat(fps.getProcessingState().getSiteCurveNumber(2), is(122));
		assertThat(fps.getProcessingState().getSiteCurveNumber(3), is(13));
		assertThat(fps.getProcessingState().getSiteCurveNumber(4), is(99));
		assertThat(fps.getProcessingState().getSiteCurveNumber(5), is(59));
	}
	...
	void testEstimateMissingSiteIndicesStep1() throws ProcessingException, IOException, ResourceParseException,
		...
		assertThat(fps.getProcessingState().wallet.siteIndices[4], is((float) expectedValue));
	}
	...
	void testEstimateMissingSiteIndicesStep2() throws ProcessingException, IOException, ResourceParseException,
		...
		PolygonProcessingState state = fps.getProcessingState();
		assertThat(state.wallet.siteIndices[1], is((float) expectedValue));
	}
	...
	void testEstimateMissingYearsToBreastHeightValues()
		...
		assertThat(
				fps.getProcessingState().wallet.yearsToBreastHeight, is(
	...
	void testCalculateDominantHeightAgeSiteIndex()
		...
		assertThat(fps.getProcessingState().getPrimarySpeciesDominantHeight(), is(23.839115f));
		assertThat(fps.getProcessingState().getPrimarySpeciesSiteIndex(), is(34.0f));
		assertThat(fps.getProcessingState().getPrimarySpeciesTotalAge(), is(15.0f));
		assertThat(fps.getProcessingState().getPrimarySpeciesAgeAtBreastHeight(), is(10.0f));
	...
	void testCalculateDominantHeightAgeSiteIndexNoSecondary()
		...
		assertThat(fps.getProcessingState().getPrimarySpeciesDominantHeight(), is(22.942902f));
		assertThat(fps.getProcessingState().getPrimarySpeciesSiteIndex(), is(34.0f));
		assertThat(fps.getProcessingState().getPrimarySpeciesTotalAge(), is(22.0f));
		assertThat(fps.getProcessingState().getPrimarySpeciesAgeAtBreastHeight(), is(Float.NaN));
		assertThat(fps.getProcessingState().getPrimarySpeciesAgeToBreastHeight(), is(4.7f));
	}
