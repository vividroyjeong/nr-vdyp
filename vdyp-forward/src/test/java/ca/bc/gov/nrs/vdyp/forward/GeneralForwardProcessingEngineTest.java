...
class GeneralForwardProcessingEngineTest {
	...
	void testCalculateDominantHeightAgeSiteIndex()
		...
		assertThat(fpe.fps.getPolygonProcessingState().getPrimarySpeciesDominantHeight(), is(23.839115f));
		...
		assertThat(fpe.fps.getPolygonProcessingState().getPrimarySpeciesAgeAtBreastHeight(), is(10.0f));
		assertThat(fpe.fps.getPolygonProcessingState().getPrimarySpeciesAgeToBreastHeight(), is(5.0f));
	}
	...
	void testCalculateDominantHeightAgeSiteIndexNoSecondary()
		...
		assertThat(fpe.fps.getPolygonProcessingState().getPrimarySpeciesDominantHeight(), is(22.942902f));
		assertThat(fpe.fps.getPolygonProcessingState().getPrimarySpeciesSiteIndex(), is(34.0f));
