...
public class VdypForwardUtilizationParserTest {
	...
	void testParseEmpty() throws Exception {
		...
		controlMap.put(ControlKey.FORWARD_VDYP_LAYER_BY_SP0_BY_UTIL_INPUT.name(), "test.dat");
		...
		var parserFactory = controlMap.get(ControlKey.FORWARD_VDYP_LAYER_BY_SP0_BY_UTIL_INPUT.name());
