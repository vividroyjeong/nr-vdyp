...
public class VdypVtrolParser implements ValueParser<VdypGrowthDetails> {
	...
	@Override
	public VdypGrowthDetails parse(String string)
		...
		if (yearCounter != -1 && (yearCounter < 0 || yearCounter > 400 && yearCounter < 1920)) {
			throw new ValueParseException(Integer.toString(yearCounter), "VdypVtrolParser: yearCounter value \"" + yearCounter + "\" is out of range");
		}
