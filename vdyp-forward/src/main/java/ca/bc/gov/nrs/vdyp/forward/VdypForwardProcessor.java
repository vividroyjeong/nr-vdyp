 ...
 *
 * VDYPPASS IN/OUT I*4(10) Major Control Functions (1) IN Perform Initiation
 * activities? (0=No, 1=Yes) (2) IN Open the stand data files (0=No, 1=Yes) (3)
 * IN Process stands (0=No, 1=Yes) (4) IN Allow multiple polygons (0=No, 1=Yes)
 * (Subset of stand processing. May limit to 1 stand) (5) IN CLOSE data files.
 * (10) OUT Indicator variable that in the case of single stand processing with
 * VDYPPASS(4) set, behaves as follows: -100 due to EOF, nothing to read other
 * -ve value, incl -99. Could not process the stand. 0 Stand was processed and
 * written +ve value. Serious error. Set to IER. IER OUTPUT I*4 Error code 0: No
 * error >0: Error 99: Error generated in routine called by this subr. <0:
 * Warning HISTORY 05DEC01 VDYPPASS(1-5) used to control all activites. (usually
 * all=1) 13JAN02 Set IYRSTART in common /YEARS/ (Same as IYRFIRST in VGROWYR)
 * 14JAN02 Optionally call SITEADDU 25JAN02 Make OPENING separate from
 * initialization 25JAN02 Set output variable VDYPPASS(10) for single-stand
 * processing
 *
