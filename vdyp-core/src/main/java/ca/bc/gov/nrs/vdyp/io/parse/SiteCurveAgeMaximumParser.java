 ...
 * <ol>
 * <li>(cols 0-2) site curve key - an integer from -1 to 40. "-1" defines the defaults for all 
 * site curves not given in the file</li>
 ...
 * <li>(cols 24-30) float - "T2". T1 and T2 are "parameters that control special site curve modifications
 * beyond max total age."</li>
 * </ol>
 * All lines in the file are read; there is no provision for blank lines. A Site Curve key of 999 stops
 * the parse; this line and all following are ignored.
 * <p>
