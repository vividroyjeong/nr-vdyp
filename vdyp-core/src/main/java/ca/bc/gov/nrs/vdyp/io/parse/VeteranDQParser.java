 ...
 * </ol>
 * If the Region value is blank, the line is applied to both Regions. All lines are read - no
 * lines are skipped, except the last line in the file if empty. All three coefficients must
 * be present on each line.
 * <p>
