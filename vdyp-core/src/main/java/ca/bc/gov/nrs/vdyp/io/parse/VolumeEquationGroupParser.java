 ...
 * The file must contain one entry for each combination of Species and BEC Zone (excluding
 * hidden BEC Zones) and thus there must be 16 * 13 values in the file (at this time.)
 * <p>
