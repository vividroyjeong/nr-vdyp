...
public class StockingClassFactorParser implements ResourceParser<Map<Character, Map<Region, StockingClassFactor>>>{
	...
	LineParser lineParser = new LineParser(){
		...
		public boolean isStopSegment(List<String> segments) {
			...
			.value(1, STK_KEY, ValueParser.CHARACTER)
			.space(1)
			.value(1, REGION_KEY, ValueParser.REGION)
			.space(1)
			.value(1, LAYER_KEY, ValueParser.CHARACTER)
			.integer(3, ITG_KEY)
			.floating(6, FACTOR_KEY)
			.integer(5, NPCT_KEY);
	...
	@Override
	public Map<Character, Map<Region, StockingClassFactor>> parse(InputStream is, Map<String, Object> control) throws IOException, ResourceParseException {
