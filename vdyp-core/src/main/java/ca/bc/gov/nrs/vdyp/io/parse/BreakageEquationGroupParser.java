...
/**
 * Breakage Group Equation parser. This file contains a list of the Breakage Group equation numbers
 * for each pair of Species and BEC Zone. The file will contain exactly one entry for each such 
 * pair (16 * 14 = 224 records).
 * <ol>
