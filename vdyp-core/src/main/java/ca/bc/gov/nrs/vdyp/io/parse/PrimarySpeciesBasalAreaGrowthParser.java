...
public class PrimarySpeciesBasalAreaGrowthParser implements ControlMapSubResourceParser<Map<Integer, ModelCoefficients>> {
	...
	public PrimarySpeciesBasalAreaGrowthParser() {
