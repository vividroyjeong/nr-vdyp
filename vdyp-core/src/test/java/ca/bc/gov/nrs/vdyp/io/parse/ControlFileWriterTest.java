...
public class ControlFileWriterTest {
	...
	public void testWriteEntry() throws Exception {
		...
		try (
				...
				var writer = new ControlFileWriter(output);
		) {
	...
	public void testWriteExtendedEntryWithComment() throws Exception {
		...
		try (
			...
			assertThat(output.toString(ControlFileWriter.CHARSET), equalTo("001XLong Value.........................................                                                                     Comment\r\n"));
	...
	public void testValidateValue() throws Exception {
		...
		try (
			...
			assertThrows(IllegalArgumentException.class, ()->{
				writer.writeEntry(3, "012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789X");
			});
			assertThrows(IllegalArgumentException.class, ()->{
	...
	public void testValidateComment() throws Exception {
		...
		try (
			...
			assertThat(output.toString(ControlFileWriter.CHARSET), equalTo(
					"001 Value                                             \r\n"+
					"002 Value                                             Comment\r\n"+
					"003 Value                                             ! Comment\r\n"+
					"    \r\n"+
