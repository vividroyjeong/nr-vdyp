...
public class CoefficientParserTest {
	...
	public void testParseSimple() throws Exception {
		...
		assertThat(result, mmHasEntry(present(is(2.0028f)), 0, "B1", (Integer)1)); // COEs are 0 indexed, species are 1 indexed
	...
	public void testBadBec() throws Exception {
		...
		var is = TestUtils.makeStream("BX   A0 0  2.0028 -0.5343  1.3949 -0.3683 -0.3343  0.5699  0.2314  0.0528  0.2366 -0.3343  0.5076  0.5076  0.6680 -0.1353  1.2445 -0.4507");
	...
	public void testBadIndex() throws Exception {
		...
		var is = TestUtils.makeStream("B1   AX 0  2.0028 -0.5343  1.3949 -0.3683 -0.3343  0.5699  0.2314  0.0528  0.2366 -0.3343  0.5076  0.5076  0.6680 -0.1353  1.2445 -0.4507");
	...
	public void testParseDelta() throws Exception {
		...
		var is = TestUtils.makeStream("B1   A0 2  2.0028 -0.5343  1.3949 -0.3683 -0.3343  0.5699  0.2314  0.0528  0.2366 -0.3343  0.5076  0.5076  0.6680 -0.1353  1.2445 -0.4507");
	...
	public void testParseFixed() throws Exception {
		...
		var is = TestUtils.makeStream("B1   A0 0  2.0028 -0.5343  1.3949 -0.3683 -0.3343  0.5699  0.2314  0.0528  0.2366 -0.3343  0.5076  0.5076  0.6680 -0.1353  1.2445 -0.4507");
